...
<body id="home">
  <nav class="navbar navbar-expand-lg navbar-dark bg-transparent" id="nav">
    <div class="container">
      <a class="navbar-brand" href="#top"><img src="./images/logos/logo.png" id="navLogo" class="img-fluid logo_navbar"
          alt="logo DRPerformance DRP" /></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a href="https://www.facebook.com/drperformance/" target="_blank" class="fa fa-facebook"></a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row pt-5">
      ...
      <div class="col-md-5 align-self-center">
        <img src="./images/benz.jpg" class="img-fluid" alt="Responsive image" />
      </div>
      <div class="col-12">
        <p>
    ...
    <footer class="pt-4 my-md-5 pt-md-5">
      <div class="row">
        <div class="col-12 col-md">
          <img src="./images/logos/logo.png" class="img-fluid" alt="logo DRPerformance DRP" style="max-width:200px;" />
